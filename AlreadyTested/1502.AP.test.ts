...
describe('Can make Arithmetic Progression From Sequence', () => {
	it('input: [3, 5, 1]; output: true', () => {
		expect(canMakeArithmeticProgression([3, 5, 1])).to.equal(true);
	});
	it('input: [1, 2, 4]; output: true', () => {
		expect(canMakeArithmeticProgression([1, 2, 4])).to.equal(false);
	});
	it('input: [1, 2]; output: true', () => {
		expect(canMakeArithmeticProgression([1, 2])).to.equal(true);
	});
});
