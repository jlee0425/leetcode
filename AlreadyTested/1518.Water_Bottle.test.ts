...
describe('Water Bottles', () => {
	it('input: 9, 3; output: 13', () => {
		expect(numWaterBottles(9, 3)).to.equal(13);
	});
	it('input: 15, 4; output: 19', () => {
		expect(numWaterBottles(15, 4)).to.equal(19);
	});
	it('input: 5, 5; output: 6', () => {
		expect(numWaterBottles(5, 5)).to.equal(6);
	});
	it('input: 2, 3; output: 2', () => {
		expect(numWaterBottles(2, 3)).to.equal(2);
	});
});
