...
describe('Longest Palindrome', () => {
	it("s = 'acbcccdd'; output: 7", () => {
		expect(longestPalindrome('acbcccdd')).to.equals(7);
	});
	it("s = 'a'; output: 1", () => {
		expect(longestPalindrome('a')).to.equals(1);
	});
	it("s = 'bb'; output: 2", () => {
		expect(longestPalindrome('bb')).to.equals(2);
	});
	it("s = 'ccc'; output: 3", () => {
		expect(longestPalindrome('ccc')).to.equals(3);
	});
	it("s ='ababababa'; output: 9", () => {
		expect(longestPalindrome('ababababa')).to.equals(9);
	});
