...
describe('Longest Increasing Subsequence', () => {
	...
	it('input: [5, 2, 8, 6, 3, 6, 9, 5]; output: 4', () => {
		expect(lengthOfLIS([5, 2, 8, 6, 3, 6, 9, 5])).to.equal(4);
	});
});

describe('Longest Increasing Subsequence with Binary Search', () => {
	it('input: [10, 9, 2, 5, 3, 7, 101, 18]; output: 4', () => {
		expect(LISWithBS([10, 9, 2, 5, 3, 7, 101, 18])).to.equal(4);
	});

	it('input: [0, 1, 0, 3, 2, 3]; output: 4', () => {
		expect(LISWithBS([0, 1, 0, 3, 2, 3])).to.equal(4);
	});

	it('input: [7, 7, 7, 7, 7, 7, 7]; output: 1', () => {
		expect(LISWithBS([7, 7, 7, 7, 7, 7, 7])).to.equal(1);
	});
	it('input: [5, 2, 8, 6, 3, 6, 9, 5]; output: 4', () => {
		expect(LISWithBS([5, 2, 8, 6, 3, 6, 9, 5])).to.equal(4);
	});
});
